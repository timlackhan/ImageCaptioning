...
my_model.load_weights("/rap_blues/lunwen/paras#/5/120/org-weights-epoch-150--val_loss-1.5054--loss-0.0002.hdf5")
...
my_model.layers[4].layers[6].set_weights(model.layers[4].layers[8].get_weights())
my_model.layers[4].layers[8].set_weights(model.layers[4].layers[10].get_weights())


optimizer = RMSprop(lr=0.0001, clipvalue=1.0)
my_model.compile(loss='categorical_crossentropy', optimizer=optimizer)
filepath="/rap_blues/lunwen/paras#/5/220/org-weights-epoch-{epoch:02d}--val_loss-{val_loss:.4f}--loss-{loss:.4f}.hdf5"
