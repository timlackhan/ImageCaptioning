...
my_model.layers[0].set_weights(model.layers[0].get_weights())
my_model.layers[1].set_weights(model.layers[1].get_weights())
...
filepath="/rap_blues/lunwen/paras#/3/220/org-weights-epoch-{epoch:02d}--val_loss-{val_loss:.4f}--loss-{loss:.4f}.hdf5"
...
dsl_path = "H:/deep_front/Screenshot-to-code-in-Keras-master/local/Bootstrap/compiler/assets/web-dsl-mapping.json"
