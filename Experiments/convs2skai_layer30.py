...
decoder_conv17 = Conv1D(48, 3, padding='valid')(decoder_17o)
decoder_gate17 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_17o)
...
decoder_conv18 = Conv1D(48, 3, padding='valid')(decoder_18o)
decoder_gate18 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_18o)
...
decoder_conv19 = Conv1D(48, 3, padding='valid')(decoder_19o)
decoder_gate19 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_19o)
...
decoder_conv20 = Conv1D(48, 3, padding='valid')(decoder_20o)
decoder_gate20 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_20o)
...
decoder_conv21 = Conv1D(48, 3, padding='valid')(decoder_21o)
decoder_gate21 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_21o)
...
decoder_conv22 = Conv1D(48, 3, padding='valid')(decoder_22o)
decoder_gate22 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_22o)
...
decoder_conv23 = Conv1D(48, 3, padding='valid')(decoder_23o)
decoder_gate23 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_23o)
...
decoder_conv24 = Conv1D(48, 3, padding='valid')(decoder_24o)
decoder_gate24 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_24o)
...
decoder_conv25 = Conv1D(48, 3, padding='valid')(decoder_25o)
decoder_gate25 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_25o)
...
decoder_conv26 = Conv1D(48, 3, padding='valid')(decoder_26o)
decoder_gate26 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_26o)
...
decoder_conv27 = Conv1D(48, 3, padding='valid')(decoder_27o)
decoder_gate27 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_27o)
...
decoder_conv28 = Conv1D(48, 3, padding='valid')(decoder_28o)
decoder_gate28 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_28o)
...
decoder_conv29 = Conv1D(48, 3, padding='valid')(decoder_29o)
decoder_gate29 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_29o)
...
decoder_conv30 = Conv1D(48, 3, padding='valid')(decoder_30o)
decoder_gate30 = Conv1D(48, 3, padding='valid', activation='sigmoid')(decoder_30o)
...
language_decoder = Dense(128, activation='relu')(decoder_31i)
...
my_model.load_weights("/rap_blues/lunwen/convs2s/kai/layer30/120/org-weights-epoch-50--val_loss-0.7308--loss-0.0089.hdf5")


json_file = open('/rap_blues/lunwen/convs2s/kai/layer30/architecture.json', 'r')
...
model.load_weights("/rap_blues/lunwen/convs2s/kai/220/org-weights-epoch-65--val_loss-0.5392--loss-0.0099.hdf5")
...
filepath="/rap_blues/lunwen/convs2s/kai/layer30/220/org-weights-epoch-{epoch:02d}--val_loss-{val_loss:.4f}--loss-{loss:.4f}.hdf5"
...
my_model.fit([image_data, X, padding_up], y, batch_size=64, shuffle=False, validation_split=0.1, callbacks=callbacks_list, verbose=1, epochs=200)

#save the model architecture
model_json = my_model.to_json()  
with open("/rap_blues/lunwen/convs2s/kai/layer30/architecture.json", "w") as json_file:  
