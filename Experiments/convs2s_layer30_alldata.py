...
def my_loadData(text_train_dir, image_train_dir, text_val_dir, image_val_dir, text_test_dir, image_test_dir):
    text = []
    images = []
    for i in range(254):
...
train_features, texts = my_loadData(text_train_dir, image_train_dir, text_val_dir, image_val_dir, text_test_dir, image_test_dir)
...
filepath="/rap_blues/lunwen/convs2s/layer_30_alldata/org-weights-epoch-{epoch:02d}--val_loss-{val_loss:.4f}--loss-{loss:.4f}.hdf5"
