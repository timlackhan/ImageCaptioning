...
image_model.add(Conv2D(128, (3,3), activation='relu', padding='same',strides=2))
...
my_model.load_weights("/rap_blues/lunwen/paras#/6/220/org-weights-epoch-65--val_loss-0.5495--loss-0.0004.hdf5")
...
my_model.layers[10].set_weights(model.layers[8].get_weights())
...
my_model.layers[4].layers[5].set_weights(model.layers[4].layers[6].get_weights())
my_model.layers[4].layers[7].set_weights(model.layers[4].layers[8].get_weights())
my_model.layers[4].layers[9].set_weights(model.layers[4].layers[10].get_weights())


optimizer = RMSprop(lr=0.0001, clipvalue=1.0)
my_model.compile(loss='categorical_crossentropy', optimizer=optimizer)
filepath="/rap_blues/lunwen/paras#/6/220/org-weights-epoch-{epoch:02d}--val_loss-{val_loss:.4f}--loss-{loss:.4f}.hdf5"
